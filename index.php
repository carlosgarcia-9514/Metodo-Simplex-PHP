    ...
    <body background="img/fondooss.PNG" style="height: 100%; width: 100%;background-size: 100%; position: relative">        
        <div class="container">
            <div id="seleccionar_metodo" class="jumbotron">
                <h1 style="color: black; font-family: time-new roman; font-size: 60px; text-align:center;">Progamación Lineal</h1>
                
                <form style="position:absolute;top:50;left: 1050px; font-size: 30px; padding-top: 85px; font-family: time-new roman; color:black">
                    <p>Emenavid Aconcha </p>
                    <p>Carlos García</p>
                    <p>Michael Hidalgo</p>
                    <p>Fay Cervantes</p>
                    <p>Michael Xxxxx</p>
                </form>
                <a onclick="display_simplex()" style="background: #006dcc" class="btn btn-lg btn-success" role="button">Simplex</a>
        ...
        <div class="row" id="simplex" style="display: none">
            ...
            <button class="btn btn-primary" onclick="crearCampos()" />Desplegar</button><hr>
                ...
                <form action="llenarTabla.php" method="post">
                    ...
                    <label style="font-size: 20px"><strong>Objetivo de la función: </strong></label>
                    <select name="tipo">
                        <option value="max">Maximizar</option>
                        <option value="min">Minimizar</option>
                    </select>
                    <br>. . . <br>
                    <label style="font-size: 20px"><strong>Función objetivo:</strong></label>
                    <div id="funcion_objetivo"></div>

                    <label style="font-size: 20px"><strong>Restricciones:</strong></label><br>
