...
<html>
    ...
    <body background="img/fondooss.PNG"  style="height: 100%; width: 100%;background-size: 100% ; position: relative">       
        ...
        <div class="row" style="text-align: center">
            <button class="btn btn-primary" style="background:#006dcc; font-size: 20px;border-radius: 4px; cursor: pointer; color:white;text-decoration:none; border: 1px solid #cccccc;padding: 4px 12px;
    margin-bottom: 0; font-family:time- new roman" onclick="changeLocation()">Ver tabla</button>
        </div>
    </body>
</html>
